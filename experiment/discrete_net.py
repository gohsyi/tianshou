...
class CNN(nn.Module):
    def __init__(self, state_shape, device='cpu', mask=None):
...
class Actor(nn.Module):
    def __init__(self, preprocess_net, action_shape):
        ...
        self.last = nn.Linear(128, int(np.prod(action_shape)))
...
class DQN(nn.Module):
    ...
    def __init__(self, h, w, action_shape, device='cpu', mask=None):
